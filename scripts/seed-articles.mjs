...
const articles = [
  {
    ...
    status: 'published',
    category: 'psych',
    created_at: 1758710816918,
    updated_at: 1758710816918,
  },
  {
    id: crypto.randomUUID(),
    title: '天赋、觉醒与多支点生活',
    ...
    status: 'published',
    category: 'life',
    created_at: 1756134620348,
    updated_at: 1756134620348,
  },
  {
    id: crypto.randomUUID(),
    ...
    status: 'published',
    category: 'science',
    created_at: 1779078619487,
    updated_at: 1779078619487,
  },
];
...
console.log(`成功插入 ${data.length} 篇文章:`);
data.forEach(a => console.log(`  - ${a.title} (${a.id})`));
