    ...
    return (
      <section ref={sectionRef} id="interests" className="scroll-mt-20 py-20 snap-section snap-overflow">
        <div className="max-w-[1100px] mx-auto px-4 sm:px-8">
          ...
          <div className="h-3 w-56 bg-[#ECD8D9]/40 dark:bg-[#334155]/40 rounded animate-pulse mb-6" />
          <div className="space-y-4 mt-8">
            {[1,2,3].map(i => (
              <div key={i} className="h-20 bg-[#ECD8D9]/20 dark:bg-[#334155]/20 rounded-xl animate-pulse" />
            ))}
          </div>
        </div>
      </section>
    ...
    <section ref={sectionRef} id="interests" className="scroll-mt-20">
      ...
      <div className="max-w-[1100px] mx-auto px-4 sm:px-8 pt-28 pb-10">
        ...
        <div className="relative max-w-[480px] mb-6">
          <input
            ...
            placeholder="搜索文章…"
            className="w-full h-11 pl-10 pr-4 rounded-xl border border-[#ECD8D9] dark:border-[#334155] bg-white dark:bg-[#1E293B] text-sm text-[#313131] dark:text-[#E2E8F0] placeholder-[#B8B4B0] outline-none focus:border-[#DA583F] transition-colors"
          />
      ...
      {(searchQuery || activeTag) ? (
        <div className="max-w-[1100px] mx-auto px-4 sm:px-8 pb-20">
          {filtered.length === 0 ? (
            <div className="text-center py-16 text-[#B8B4B0] dark:text-[#94A3B8]">没有找到匹配的文章</div>
          ) : (
        ...
        <>
          {categories.map(cat => {
            ...
            return (
              <div key={cat.key} className="py-16 px-4 sm:px-8 border-t border-[#ECD8D9] dark:border-[#334155] first:border-t-0">
                <div className="max-w-[1100px] mx-auto">
                  ...
                  {hasArticles ? (
                    ...
                    <div className="mt-8 p-10 text-center bg-white dark:bg-[#1E293B] border border-dashed border-[#ECD8D9] dark:border-[#334155] rounded-2xl">
  ...
  return (
    <div className="flex items-center gap-3 mb-2">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-[#B8B4B0] dark:text-[#94A3B8]">{count} 篇文章 · {cat.description}</p>
      </div>
    </div>
  );
}
...
function ArticleCard({ article }: { article: Article }) {
  return (
    <Link
      ...
      className="group bg-white dark:bg-[#1E293B] border border-[#ECD8D9] dark:border-[#334155] rounded-2xl p-5 hover:border-[#DA583F] hover:-translate-y-0.5 hover:shadow-[0_8px_30px_rgba(218,88,63,0.06)] transition-all duration-300 flex flex-col"
    >
      ...
      <p className="text-xs text-[#767693] dark:text-[#94A3B8] line-clamp-2 mb-3 ml-7 flex-1">
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FEFAF9] dark:bg-[#0A0E1A] text-[#313131] dark:text-[#E2E8F0] font-['PingFang_SC','Microsoft_YaHei','Noto_Sans_SC',sans-serif] transition-colors duration-300 overflow-x-hidden">
      <Helmet>
      ...
      >
        ...
        <div className="text-center relative z-10 max-w-[720px] w-full">
          ...
          <p className="text-[1.1rem] text-[#6E6A7C] dark:text-[#94A3B8] leading-relaxed mb-10 max-w-[480px] mx-auto">
            知无不言，正直之极。<br />
            以理性观照心灵，以热忱探索未知。
          </p>
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5 sm:hidden animate-bounce opacity-40">
          <span className="text-[10px] tracking-[0.15em] text-[#767693] dark:text-[#94A3B8]">上滑探索</span>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#767693] dark:text-[#94A3B8]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
            ...
            <RevealOnScroll>
              <div className="flex flex-col items-center md:items-start">
                ...
                <p className="text-[0.98rem] text-[#4F4F4F] dark:text-[#94A3B8] mb-4 leading-relaxed">
                  精神科医师，ENTP人格。一个对心灵世界永远好奇的探索者——在理性与直觉、科学与人文的边界游走。
                </p>
                <p className="text-[0.98rem] text-[#4F4F4F] dark:text-[#94A3B8] leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <RevealOnScroll key={s.label}>
                  <div className="bg-white dark:bg-[#1E293B] border border-[#ECD8D9] dark:border-[#334155] rounded-xl p-8 text-center hover:border-[#DA583F] hover:shadow-[0_8px_30px_rgba(218,88,63,0.08)] transition-all">
                    <div
                    ...
                    <div className="text-[0.85rem] text-[#767693] dark:text-[#94A3B8] mt-1.5">{s.label}</div>
                  </div>
                </RevealOnScroll>
              ))}
            </div>
      ...
      <section className="snap-section snap-overflow py-20 sm:py-32 px-4 sm:px-8" id="work">
        <div className="max-w-[1100px] mx-auto">
          ...
          <RevealOnScroll>
            <Link
              to="/travels"
              className="mt-12 group flex items-center gap-3 sm:gap-5 bg-[#FEF3F0] dark:bg-[#1E293B] border border-[#ECD8D9] dark:border-[#334155] rounded-2xl p-4 sm:p-8 hover:border-[#DA583F] hover:shadow-[0_8px_30px_rgba(218,88,63,0.08)] transition-all duration-300"
            >
        ...
        <div className="max-w-[1100px] mx-auto">
          ...
          <RevealOnScroll>
            <div className="bg-white dark:bg-[#1E293B] border border-[#ECD8D9] dark:border-[#334155] rounded-3xl p-8 sm:p-16 text-center max-w-[600px] mx-auto hover:border-[#DA583F] hover:shadow-[0_16px_50px_rgba(218,88,63,0.06)] transition-all">
              <p className="text-[1.05rem] text-[#4F4F4F] dark:text-[#94A3B8] mb-8">
                来玄牙的世界坐坐，聊聊你最近在想的事。
              </p>
      ...
      <footer className="text-center py-12 sm:py-16 px-4 sm:px-8 text-[0.85rem] text-[#767693] dark:text-[#94A3B8] border-t border-[#ECD8D9] dark:border-[#334155]">
        ...
        <div className="max-w-[640px] mx-auto mt-8 pt-4 border-t border-dashed border-[#ECD8D9] dark:border-[#334155] text-left text-xs leading-relaxed">
          ...
          <p className="text-[#767693] dark:text-[#94A3B8] mb-1.5">
            本站内容仅供信息参考与个人观点表达，不构成任何形式的医疗建议、诊断或治疗意见。如有心理健康困扰，请务必前往正规医疗机构就诊，切勿将本站内容替代专业诊疗。
          </p>
          <h4 className="text-[0.8rem] text-[#313131] dark:text-[#E2E8F0] font-semibold mt-2 mb-1">版权声明</h4>
          <p className="text-[#767693] dark:text-[#94A3B8]">
