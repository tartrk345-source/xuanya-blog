    ...
    return (
      <div className="min-h-screen bg-[#FEFAF9] dark:bg-[#0A0E1A] flex items-center justify-center">
        ...
        <div className="w-full max-w-3xl mx-auto px-6 animate-[fadeIn_0.4s_ease-out]">
          <div className="h-8 w-32 bg-[#ECD8D9]/40 dark:bg-[#334155]/40 rounded-lg mb-6" />
          <div className="h-10 w-3/4 bg-[#ECD8D9]/40 dark:bg-[#334155]/40 rounded-lg mb-3" />
          <div className="h-6 w-1/4 bg-[#ECD8D9]/30 dark:bg-[#334155]/30 rounded-lg mb-12" />
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="mb-3 space-y-2">
              <div
                className="h-[18px] bg-[#ECD8D9]/25 dark:bg-[#334155]/25 rounded"
                style={{ width: `${70 + Math.random() * 30}%` }}
              />
              <div
                className="h-[18px] bg-[#ECD8D9]/20 dark:bg-[#334155]/20 rounded"
  ...
  return (
    <div className="min-h-screen bg-[#FEFAF9] dark:bg-[#0A0E1A] transition-colors duration-300">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16 animate-[fadeIn_0.4s_ease-out]">
        ...
        {/* 封面图 */}
        {article.coverImage && (
          <div className="mb-10 rounded-2xl overflow-hidden border border-[#ECD8D9] dark:border-[#334155] shadow-sm">
            <img
        ...
        {/* 文章头部 */}
        <header className="mb-10 pb-10 border-b border-[#ECD8D9] dark:border-[#334155]">
          <div className="flex items-baseline gap-3 mb-4">
            <span className="text-3xl select-none" title={EMOJI_MEANINGS[article.emoji] || ''}>{article.emoji}</span>
            <h1 className="text-3xl font-bold text-[#313131] dark:text-[#E2E8F0] leading-tight tracking-tight">
              {article.title}
            </h1>
          </div>
          <div className="flex items-center gap-3 flex-wrap">
            <time className="text-sm text-[#767693] dark:text-[#94A3B8]" dateTime={new Date(article.createdAt).toISOString()}>
              {formatDate(article.createdAt)}
              {article.updatedAt !== article.createdAt && ' · 已编辑'}
            </time>
            <span className="text-sm text-[#B8B4B0] dark:text-[#94A3B8]">
              · {readingTime} 分钟阅读
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {relatedArticles.map(a => (
                ...
                >
                  ...
                  <p className="text-xs text-[#767693] dark:text-[#94A3B8] line-clamp-2 ml-7 mb-1">
        ...
        {(prevArticle || nextArticle) && (
          <div className="mt-12 pt-8 border-t border-[#ECD8D9] dark:border-[#334155]">
